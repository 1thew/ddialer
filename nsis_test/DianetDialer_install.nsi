...
Section Install
  ...
  CreateShortCut "$SMPROGRAMS\DIANET\Удалить.lnk" "$INSTDIR\uninstall.exe" "" "$INSTDIR\uninstall.exe" 0
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\DIANET\Удалить.lnk"
