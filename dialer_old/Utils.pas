...
begin
   try
      ...
      try
         i:=IdHTTP1.Get(UpdateLink);
         AssignFile(OutputFile, 'update.exe');
         ReWrite(OutputFile);
         Write(OutputFile, i);                          // заряжаем строку в файл
         CloseFile(OutputFile);
   ...
   begin
     case ip.c of
      28:
              ...
              AddRoute('172.16.32.0','255.255.240.0','172.16.28.1');
              AddRoute('172.16.48.0','255.255.248.0','172.16.28.1');
              end;
      29:
              begin
			  Filial:='aleysk';
      ...
      40:
              ...
              AddRoute('172.16.28.0','255.255.252.0','172.16.40.1');
              AddRoute('172.16.32.0','255.255.248.0','172.16.40.1');

              AddRoute('172.16.42.0','255.255.254.0','172.16.40.1');
              AddRoute('172.16.44.0','255.255.252.0','172.16.40.1');
      ...
      46:
              ...
              AddRoute('172.16.28.0','255.255.252.0','172.16.46.1');
              AddRoute('172.16.32.0','255.255.248.0','172.16.46.1');
              AddRoute('172.16.40.0','255.255.252.0','172.16.46.1');
   ...
   begin
    case ip.c of
          32:
              ...
              AddRoute('172.16.28.0','255.255.252.0','172.16.32.1');     //22

              AddRoute('172.16.34.0','255.255.252.0','172.16.32.1');
              AddRoute('172.16.36.0','255.255.252.0','172.16.32.1');
              AddRoute('172.16.40.0','255.255.248.0','172.16.32.1');     //21
              AddRoute('172.16.48.0','255.255.254.0','172.16.32.1');     //23
              end;
	  33:
              begin
			   Filial:='belokuriha';
          ...
          42:
              ...
              AddRoute('172.16.28.0','255.255.252.0','172.16.42.1');     //22
              AddRoute('172.16.32.0','255.255.248.0','172.16.42.1');     //21
              AddRoute('172.16.40.0','255.255.254.0','172.16.42.1');
              AddRoute('172.16.44.0','255.255.252.0','172.16.42.1');     //22
              AddRoute('172.16.48.0','255.255.254.0','172.16.42.1');     //23
              end;
          43:
              begin
			   Filial:='belokuriha';
